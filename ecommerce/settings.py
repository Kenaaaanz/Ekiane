...
TWILIO_ORDER_ADMIN_SMS_TEMPLATE = config('TWILIO_ORDER_ADMIN_SMS_TEMPLATE', default='')
TWILIO_ORDER_CUSTOMER_SMS_TEMPLATE = config('TWILIO_ORDER_CUSTOMER_SMS_TEMPLATE', default='')
...
# Logging configuration for debugging payments and webhooks
LOGGING = {
    'version': 1,
